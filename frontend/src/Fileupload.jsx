                  ...
                  selectedFiles.map((file) => {
                    return (
                      ...
                      <div className="flex flex-row mt-[5px] justify-between items-center ">
                        ...
                        <img
                          src={logo}
                          className="w-[26px] h-[22px] mr-[8px]"
                        />
                        <p className="text-lg">{file.name}</p></div>
                        <a className="p-[4px]" >
                        <img src={deleteLogo} onClick={()=>deleteFile(file.name)} className="w-[20px] h-[20px]  justify-end mr-[10px]"  />
                        </a>
                      </div>
                      </div>
                    );
